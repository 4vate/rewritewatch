...
// Translations by 4vate 2021

// スピーチ
var G_speach_array = Array(
	Array(
		// Array("おはよう。", "今日もしゃきっと頼むぞ。"),
		Array("Good morning.", "I'll see you later today."),
		// Array("あ、うん…おはよう…", "いや、寝顔など見ていたわけでは…"),
		Array("Oh, um... good morning...", "No, I definitely wasn't watching you sleep..."),
		// Array("今日はびしびし行くぞ！", "覚悟しろ！")
		Array("We're going all-in today!", "Prepare to die!")
	),
	Array(
		// Array("お昼はしっかりとらないとな。", ""),
		Array("I need to take a good lunch.", ""),
		// Array("眠い時間だろうが、", "気を引き締めてな。")
		Array("I know you're still sleepy", "but keep your head up.")
	),
	Array(
		// Array("お、おやつ…？", "わ、私はいい。"),
		Array("Oh, a snack...?", "I don't want it."),
		// Array("そういえば美味しいスナックがある。", "ピリッとして中々美味しいぞ。")
		Array("Come to think of it, there are good snacks.", "Some are tangy and tasty.")
	),
	Array(
		// Array("夕食もバランスよく摂るんだぞ。", "食べすぎは良くないからな。"),
		Array("You'll have to have a balanced dinner.", "You don't want to overeat."),
		// Array("明日に備えてやることはないか？", ""),
		Array("Is there anything we need to prepare for tomorrow?", ""),
		// Array("一番リラックスできる時間かもしれないな。", "")
		Array("This is the most peaceful time of the day for me.", "")
	),
	Array(
		// Array("早めに寝ることが、", "健康の秘訣だぞ。"),
		Array("Go to bed early,", "it's the key to good health."),
		// Array("お前は夜更かしが好きだな。", ""),
		Array("You like to stay up late, don't you?", ""),
		// Array("私はもう眠くなってきた。", "先に寝ていいか…？")
		Array("Can I go to bed first...?", "I'm already getting sleepy.")
	)
);
