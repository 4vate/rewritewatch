...
// Translations by 4vate 2022

// スピーチ
var G_speach_array = Array(
	Array(
		// Array("今日も一日、", "のんびりいきたいもんだねぇ～"),
		Array("Here's to another happy-go-lucky day!", ""),
		// Array("小鳥さんの朝は早い。", "まず二度寝るのだ…"),
		Array("Kotori wakes up early in the mornings.", "By going to bed a second time..."),
		// Array("組み体操の隊形に…ひらけ！", "")
		Array("To the gymnastic position, go!", "")
	),
	Array(
		// Array("お昼はヅャスコのコロッケだよ。", "しゃーわせだよー"),
		Array("Jasco croquettes are the best lunch.", "I'm so happy!"),
		// Array("ふふんふんふ～ん♪", "ハトのふ～ん♪"),
		Array("Coo coo coo♪", "Just like a pigeon♪"),
		// Array("おべんと、総額１５０円～♪", "５０円はぶたさん貯金～♪")
		Array("The bento was 150 yen.♪", "50 yen go to the piggy-bank!♪")
	),
	Array(
		// Array("おやつのじかん！", "ハッピネス！"),
		Array("Time for a snack!", "\"Happiness\"!"),
		// Array("昨日のタイムセールスぼたもち！", "うまーーーーい！"),
		Array("Yesterday's daily mochi sale is...", "delicious!"),
		// Array("優雅に午後をすごしたいねぇ…", "")
		Array("Here's to a fancy afternoon!", "")
	),
	Array(
		// Array("ふしだらＮＧ！", ""),
		Array("ふしだらＮＧ！", ""),
		// Array("よせや～い…", "")
		Array("よせや～い…", ""),
		// Array("どうしてそこであきらめんの！", "できる！　オカムラさんできる！"),
		Array("What are you giving up for?", "You can do it, Okamura-san!"),
		// Array("おかしいな、変だな…", "（ジュンジ）")
		Array("That's weird... Very weird...", "(Junji)")
	),
	Array(
		// Array("小鳥さんはもうねむねむ…", ""),
		Array("Kotori-san is feeling sleepy...", ""),
		// Array("ぐうぴい…", ""),
		Array("Yawn...", ""),
		// Array("りっぱなおだいじんになるのだよ……", ""),
		Array("I want to grow up right...", ""),
		// Array("窓の外に光が…", "すぅーっと動くんですね…（ジュンジ）")
		Array("The lights outside the window...", "Are moving a lot... (Junji)")
	)
);
