...
var G_speach_array = Array(
	Array(
		// Array("おはよう。今日もがんばろう。", ""),
		Array("Good morning. Let's do our best today.", ""),
		// Array("……（寝ている）", ""),
		Array("...(Sleeping)", ""),
		// Array("……（レッツビギン）", ""),
		Array("...(Let's start)", ""),
		// Array("むう…さんまが食べたい…", "")
		Array("Mmm... I want to eat saury...", "")
	),
	Array(
		// Array("ランチはさんま…", ""),
		Array("For lunch, I had saury...", ""),
		// Array("……（ヘイカモン）", ""),
		Array("...(Hey, Come On)", ""),
		// Array("はむはむ…", "")
		Array("Mmmm, hmmm...", "")
	...
	Array(
		...
		Array("Good luck!", ""),
		// Array("おやつ…いっしょに食べる？", ""),
		Array("Snack...", "Do you want to share?"),
		// Array("さーんまーのー", "うーたー♪")
		Array("Saury~", "Wow~♪")
	),
	Array(
		// Array("……（ディナーにさんまはどうかしら…）", ""),
		Array("...(I think about saury for dinner...)", ""),
		// Array("お野菜も食べる……", ""),
		Array("Eat your vegetables too...", ""),
		// Array("……", "考え．ｃｏｍ…")
		Array("...", "Thinking, dot com.")
	),
	Array(
		// Array("……（寝ている）", ""),
		Array("...(He's slepeing)", ""),
		// Array("……すかー", "（とても気持ちよさそうに寝ている）"),
		Array("...Is he?", "(He looks comfortable while sleeping)"),
		// Array("……（うふん。いやん）", "（と考えてみるもビジョンはない）")
		Array("...(Hmmm, no.)", "(I've been thinking about it but I don't know)")
	)
);
