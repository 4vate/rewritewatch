...
// Translations by 4vate, yousei 2021

// スピーチ
var G_speach_array = Array(
	Array(
		// Array("あら。", "今日も無駄な一日を始めるのね…"),
		Array("Oh, Let's start another wasted day...", ""),
		// Array("寝ているほうが有意義だわ。", ""),
		Array("It's more productive to just sleep.", ""),
		// Array("朝日…おのれ…", "")
		Array("Morning sunlight... annoying...", "")
	),
	Array(
		// Array("はっ！？", "う、うたたねなどしていないのだわ…"),
		Array("Huh!?", "Oh, I didn't snooze..."),
		// Array("なにか愉快なことはないかしら。", "午後は暇なの。")
		Array("I'm free this afternoon.", "I wonder if there's anything interesting.")
	),
	Array(
		// Array("お前が雀蜂の子をとってきて、", "私がそれを眺めるというのはどう？"),
		Array("How about you find some maggots...", "I will look at them later."),
		// Array("このアイスは９０点ね……", "")
		Array("This ice cream is only 90 calories...", "")
	),
	Array(
		// Array("スナイプのマウスが冴えるわ…", "キルスコアが伸びそうね。"),
		Array("That snipers aim is amazing...", "His killstreak keeps rising."),
		// Array("そろそろゴールデンタイムね……", "（ＰＣ複数起動）"),
		Array("It's almost golden hour...", "(multiple PC's booting up.)"),
		// Array("クソ虫は寝る前に死ぬべきね。", "")
		Array("Stupid bugs should die before they sleep.", "")
	),
	Array(
		// Array("いいからさっさと寝るがいいわ。", "起きていても無駄よ。"),
		Array("Just go to bed, and get some sleep.", "There's no point in staying awake."),
		// Array("夜はこれからよ。", "お前はもう寝ていいけど。"),
		Array("The night is just beginning.", "Although you can sleep now."),
		// Array("ちょ、ちょっと！", "こんな時間に…"),
		Array("Hey, hey!", "Not at this hour..."),
		// Array("日の出前くらいが", "一番頭が冴えるわ…"),
		Array("Just before the sunrise,", "it's the best time to reflect..."),
		// Array("はっ！？　邪悪な気配……", "お前、さっさと寝なさい！")
		Array("Oh! A hint of evil:", "You, get some sleep now!")
	)
);
