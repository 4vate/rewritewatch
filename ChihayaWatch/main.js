...
var G_speach_array = Array(
	Array(
		// Array("おはようございます！", "今日もがんばりましょうー"),
		Array("Good morning!", "Have a lucky day!"),
		// Array("今日はなにか、", "良いことあるといいですねぇ～"),
		Array("I hope something good will", "happen to you today!"),
		// Array("いや朝からちはやビームで", "起こしたりはしませんけど…")
		Array("I know that won't wake up,", "...but I still will try using the Chihaya Light")
	),
	Array(
		// Array("ごはんのじかんですー", ""),
		Array("It's dinner time!", ""),
		// Array("お昼寝でもしたいですねえ……", ""),
		Array("I would love to take a nap right now...", ""),
		// Array("いやちはやジェットで", "エンジョイしたりとかないですけど……")
		Array("I didn't really enjoy the Chihaya Jet...", "")
	),
	Array(
		// Array("おかしのじかんですー", "もぐもぐー"),
		Array("It's time for a snack!", "*munch munch*"),
		// Array("ぽてこ食べますー", ""),
		Array("I'll have some Poteco!", ""),
		// Array("からめるこーん食べますー", ""),
		Array("I'm going to eat Caramel Corn!", ""),
		// Array("チョコバナナが食べたいですー", "")
		Array("I want a chocolate banana!", "")
	),
	Array(
		// Array("夕食のじかんですー", "ぱくぱくー"),
		Array("It's dinner time!", "*munch munch*"),
		// Array("そろそろ眠いですねぇ…", ""),
		Array("I'm getting sleepy now...", ""),
		// Array("咲夜のプリンおいしいですー", "")
		Array("Sakuya's pudding is delicious!", "")
	),
	Array(
		// Array("すやすや…", ""),
		Array("*snoring*…", ""),
		// Array("わーいぽてこがいっぱいですー…", "むにゃむにゃ…"),
		Array("There's so much Poteco...!", "*chewing*"),
		// Array("うーん…もう食べられないです…", ""),
		Array("uhg... I can't eat any more...", ""),
		// Array("うわーっ、ぱんけーきがー…", "逃げないでくださいー…むにゃ…")
		Array("Woah, the pancakes are...", "Please don't run away...! *munch munch*")
	)
);
